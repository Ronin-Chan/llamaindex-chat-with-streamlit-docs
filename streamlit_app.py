...
st.title("Chat with CiiLOCK chatbot")
...
def load_data():
    with st.spinner(text="Loading and indexing the Streamlit docs - hang tight! This should take 1-2 minutes."):
        ...
        service_context = ServiceContext.from_defaults(llm=OpenAI(model="gpt-3.5-turbo", temperature=0.5, system_prompt="You are an expert at answering questions and your job is to answer technical questions. Keep your answers technical and based on facts - do not hallucinate features. If you do not know the answer, respond with \"Sorry, I don't know.\""))
